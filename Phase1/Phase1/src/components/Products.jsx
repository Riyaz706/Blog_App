...
function Products() {
    ...
    return (
      <div className="min-h-screen bg-blue-400 py-12 px-4 sm:px-6 lg:px-8">

          <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">Tech Gadgets</h1>
            <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">Explore our latest collection of premium tech products.</p>
          </div>
